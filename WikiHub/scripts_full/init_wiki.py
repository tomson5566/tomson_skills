...
"""
WikiHub Script: init_wiki

Purpose:
- Initialize a new WikiHub workspace with the expected root files and directories.

Usage:
- Prefer `python scripts/wikihub init ...`.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Initialize a new portable WikiHub workspace.")
