...
def convert_with_markitdown(source_path: Path) -> str:
    ...
    try:
        ...
        raise SystemExit(
            ...
            "Install WikiHub runtime dependencies before converting office documents."
        ) from exc
    try:
...
def ensure_entity_page(
    ...
    entity_summary = str(existing_meta.get("summary") or "").strip() or f"{entity_title} is an entity tracked in WikiHub."
