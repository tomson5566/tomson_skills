...
"""
WikiHub Script: doctor

Purpose:
- Check whether the local WikiHub runtime supports the expected import and conversion capabilities.

Usage:
- Prefer `python scripts/wikihub doctor ...`.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check that the WikiHub skill package is usable.")
