...
"""
WikiHub Module: runtime_capabilities

Purpose:
- Describe and check the runtime capabilities that WikiHub depends on for imports and conversions.
...
def missing_dependency_message(source_path: Path, items: list[dict[str, str]]) -> str:
    ...
    return (
        ...
        "Run `python scripts/wikihub bootstrap` again after fixing package index or network access, "
