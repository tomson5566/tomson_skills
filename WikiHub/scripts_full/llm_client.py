...
"""
WikiHub Module: llm_client

Purpose:
- OpenAI-compatible chat completion client for crystallize and digest.
- Disabled unless WIKIHUB_LLM_* environment variables are fully configured.
"""
...
_SYSTEM_PROMPT = (
    "You are a knowledge synthesis assistant for WikiHub, a personal knowledge base. "
