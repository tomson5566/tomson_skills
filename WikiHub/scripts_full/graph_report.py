...
"""
WikiHub Script: graph_report

Purpose:
- Generate a governance report from the current graph outputs.

Usage:
- Prefer `python scripts/wikihub graph-report ...`.
...
<head>
  ...
  <title>WikiHub Graph Report</title>
  <style>
    :root {{
      --bg: #0b1020;
      --panel: #121935;
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a deterministic graph health report from the current WikiHub graph data.")
